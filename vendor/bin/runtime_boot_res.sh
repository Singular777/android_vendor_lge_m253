...
if [ -d /OP ]; then
    ANI_ROOT_PATH=OP
    /system/bin/chown -R system:system /OP
    /system/bin/chmod -R 0771 /OP
    /system/bin/chmod -R 0644 /OP/$SUBCA_FILE/power*/*
    /system/bin/chmod -R 0755 /OP/*/apps/*
    /system/bin/chmod -R 0644 /cust/*/config/apps_prop
    /system/bin/chmod 0644 /OP/_COMMON/app-enabled-conf.json
